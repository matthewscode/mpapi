	...
	<div class="ft-work-box" ng-show="showEditor">
		...
		<div class="ft-work-editors">
		 <div class="ft-detail-transcription">
			...
			<div class="ft-button-wrapper">
				...
				<button  type="button" class="ts-button" ng-click="submitTranscription('<c:url value="/api/transcription/create/" />', transcriptionId, transcriptionText, checksumId)">TRANSCRIPTION <font color="#b2c9de">EN</font></button>
				<div class="ft-pad"></div>
		...
		<div class="ft-detail-translation">
			...
			<div class="ft-button-wrapper">
				...
				<div class="ft-pad"></div>
				<button type="button" class="button-full" ng-click="submitTranslation('<c:url value="/api/translation/create/" />', translationText, transcriptionId)">TRANSLATION <font color="#b2c9de">ES</font></button>
				<div class="ft-pad"></div>
